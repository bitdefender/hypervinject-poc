...
{
    // First part is the kernel shellcode, which is responsabile for injecting the user-mode
    // shellcode inside the target process. Check out shellcde\shellcode.asm for the source code.
